...
def main():
    ...
    if not all([store_url, api_key, access_token]):
    ...
    try:
        ...
        print(f"Connecting to {store_url} to create draft product...")
        ...
        if new_product.id:
            ...
            print(f"View draft: https://{store_url}/admin/products/{new_product.id}")
        else:
